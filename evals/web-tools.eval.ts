...
describe('Web Tools', () => {
  /**
   * When asked about something that requires current information not available
   * in local files, the agent should use web_search.
   */
   ...
   * web_fetch rather than web_search.
   */
  evalTest('USUALLY_PASSES', {
